...
11. Publish or schedule to Instagram
   ...
   - Use the queue controls to cancel a scheduled publish or reschedule a queued/failed job without leaving the editor.
...
- Failed jobs stay visible in the publish queue with their latest error so they can be retried or rescheduled.
