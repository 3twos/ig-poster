...
- the checked-in native scaffold should stay in sync with the web/CLI bridge contract so future web, CLI, and MCP flows all target the same localhost interface
