...
- `src/lib/creative.ts`: generation schemas, prompt builders, fallback output, structured refine-plan parsing/enforcement helpers, deterministic overlay fitting, brief-aware finalist ranking heuristics, and refine-time overlay sync helpers.
